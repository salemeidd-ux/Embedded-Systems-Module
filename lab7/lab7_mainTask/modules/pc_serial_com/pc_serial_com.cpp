...
static void commandShowLastGateEvent();
...
{
    availableCommands();
    pcSerialComStringWrite( "Default keypad code: 18059\r\n\r\n" );
}
...
static void pcSerialComCommandUpdate( char receivedChar )
{
    switch ( receivedChar ) {
        ...
        case 'i': case 'I': commandShowLastGateEvent(); break;
...
static void availableCommands()
{
    ...
    pcSerialComStringWrite( "Press '3' to get the over temperature state\r\n" );
    pcSerialComStringWrite( "Press '4' to enter the 5-digit alarm code\r\n" );
    pcSerialComStringWrite( "Press '5' to enter a new 5-digit alarm code\r\n" );
    pcSerialComStringWrite( "Press 'f' or 'F' for Fahrenheit\r\n" );
    pcSerialComStringWrite( "Press 'c' or 'C' for Celsius\r\n" );
    pcSerialComStringWrite( "Press 's' or 'S' to set date and time\r\n" );
    pcSerialComStringWrite( "Press 't' or 'T' to get date and time\r\n" );
    pcSerialComStringWrite( "Press 'e' or 'E' to get stored events\r\n" );
    pcSerialComStringWrite( "Press 'm' or 'M' to show motor status\r\n" );
    pcSerialComStringWrite( "Press 'g' or 'G' to show gate status\r\n" );
    pcSerialComStringWrite( "Press 'i' or 'I' to show last interrupt/event\r\n" );
    pcSerialComStringWrite( "\r\nKeypad: 1=open 2=close 3=stop 4=gas 5=temp 6=mode\r\n\r\n" );
}
...
{
    if( sirenStateRead() ) {
        pcSerialComStringWrite( "Please enter the five digits numeric code " );
...
static void commandEnterNewCode()
{
    pcSerialComStringWrite( "Please enter the new five digits numeric code " );
    pcSerialComStringWrite( "to deactivate the alarm: " );
    numberOfCodeChars = 0;
...
static void commandShowCurrentMotorState()
{
    switch ( motorDirectionRead() ) {
        ...
        case DIRECTION_1:
            pcSerialComStringWrite( "The motor is driving the gate open\r\n" );
        break;

        case DIRECTION_2:
            pcSerialComStringWrite( "The motor is driving the gate closed\r\n" );
        break;
    }
}
...
{
    char str[80] = "";
    sprintf( str, "Gate=%s, Mode=%s\r\n", gateStatusString(), gateModeString() );
    pcSerialComStringWrite( str );
}

static void commandShowLastGateEvent()
{
    pcSerialComStringWrite( "Last event: " );
    pcSerialComStringWrite( gateLastEventString() );
    pcSerialComStringWrite( "\r\n" );
}
